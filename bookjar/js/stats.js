...
var DPLANE = new THREE.Plane(new THREE.Vector3(0, 0, 1), -0.5); // plano vertical Z=0.5, cara frontal estantería
...
var JP = new THREE.Vector3(5.5, 0.55, 0.1);  // posición del bote
...
// ── Atmósfera ─────────────────────────────────────
var isNight       = true;     // modo día/noche
